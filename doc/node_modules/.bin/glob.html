...
<span class="hljs-keyword">import</span> { loadPackageJson } <span class="hljs-keyword">from</span> <span class="hljs-string">'package-json-from-dist'</span>;
...
<span class="hljs-keyword">const</span> { version } = loadPackageJson(<span class="hljs-keyword">import</span>.meta.url, <span class="hljs-string">'../package.json'</span>);
<span class="hljs-keyword">const</span> j = jack({
  ...
  `</span>)
    ...
    <span class="hljs-attr">platform</span>: {
        ...
        <span class="hljs-attr">validOptions</span>: [
...
<span class="hljs-keyword">try</span> {
    ...
    <span class="hljs-keyword">const</span> patterns = values.all ? positionals : positionals.filter(<span class="hljs-function"><span class="hljs-params">p</span> =&gt;</span> !existsSync(p));
