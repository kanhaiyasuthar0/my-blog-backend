...
<span class="hljs-keyword">var</span> updateDb = <span class="hljs-built_in">require</span>(<span class="hljs-string">'update-browserslist-db'</span>)
...
<span class="hljs-keyword">var</span> USAGE =
  ...
  <span class="hljs-string">'  npx browserslist --ignore-unknown-versions\n'</span>
...
<span class="hljs-keyword">if</span> (isArg(<span class="hljs-string">'--help'</span>) || isArg(<span class="hljs-string">'-h'</span>)) {
  ...
  <span class="hljs-comment">/* c8 ignore next 8 */</span>
  process.stdout.write(
    <span class="hljs-string">'The --update-db command is deprecated.\n'</span> +
      <span class="hljs-string">'Please use npx update-browserslist-db@latest instead.\n'</span>
  )
  process.stdout.write(<span class="hljs-string">'Browserslist DB update will still be made.\n'</span>)
  ...
  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; args.length; i++) {
    ...
    <span class="hljs-keyword">if</span> (name === <span class="hljs-string">'--config'</span> || name === <span class="hljs-string">'-b'</span>) {
      ...
      <span class="hljs-comment">/* c8 ignore next */</span>
      opts.mobileToDesktop = <span class="hljs-literal">true</span>
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (name === <span class="hljs-string">'--ignore-unknown-versions'</span>) {
      <span class="hljs-comment">/* c8 ignore next */</span>
      opts.ignoreUnknownVersions = <span class="hljs-literal">true</span>
    } <span class="hljs-keyword">else</span> {
  ...
  <span class="hljs-keyword">try</span> {
    ...
    <span class="hljs-keyword">if</span> (e.name === <span class="hljs-string">'BrowserslistError'</span>) {
      error(e.message)
    } <span class="hljs-comment">/* c8 ignore start */</span> <span class="hljs-keyword">else</span> {
      <span class="hljs-keyword">throw</span> e
    } <span class="hljs-comment">/* c8 ignore end */</span>
  }
