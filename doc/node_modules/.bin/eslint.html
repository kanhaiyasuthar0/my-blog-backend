...
<span class="hljs-comment">/* eslint no-console:off -- CLI */</span>
...
<p>to use V8's code cache to speed up instantiation time</p>
        ...
        <td class="code highlight">
          <pre class="javascript">mod.enableCompileCache?.();
...
<p>Lazy loading because this is used only if an error happened.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-keyword">const</span> util = <span class="hljs-built_in">require</span>(<span class="hljs-string">"node:util"</span>);
...
<p>Foolproof -- third-party module might throw non-object.</p>
...
<div class="dox">
<div class="summary">
<p>Tracks error messages that are shown to the user so we only ever show the
same message once.</p>
</div>
<div class="body">
</div>
...
<div class="dox_tag_detail">
<span class="dox_type">Set.&lt;string&gt;</span>
</div>
</div>
</div>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> displayedErrors = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Set</span>();
...
<div class="dox">
<div class="summary">
<p>Tracks whether an unexpected error was caught</p>
</div>
<div class="body">
</div>
<div class="details">
...
<span class="dox_type">boolean</span>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">let</span> hadFatalError = <span class="hljs-literal">false</span>;
...
<span>The thrown error object.
	...
	hadFatalError = <span class="hljs-literal">true</span>;
...
<span class="hljs-subst">${getErrorMessage(error)}</span>`</span>;

	<span class="hljs-keyword">if</span> (!displayedErrors.has(message)) {
...
<p><code>eslint --init</code> has been moved to <code>@eslint/create-config</code></p>

        </td>
        <td class="code highlight">
          <pre class="javascript">		<span class="hljs-built_in">console</span>.warn(
			<span class="hljs-string">"You can also run this command directly using 'npm init @eslint/config@latest'."</span>,
		);

		<span class="hljs-keyword">const</span> spawn = <span class="hljs-built_in">require</span>(<span class="hljs-string">"cross-spawn"</span>);

		spawn.sync(<span class="hljs-string">"npm"</span>, [<span class="hljs-string">"init"</span>, <span class="hljs-string">"@eslint/config@latest"</span>], {
...
<p>Otherwise, call the CLI.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-keyword">const</span> cli = <span class="hljs-built_in">require</span>(<span class="hljs-string">"../lib/cli"</span>);
	<span class="hljs-keyword">const</span> exitCode = <span class="hljs-keyword">await</span> cli.execute(
		process.argv,
...
<div class="dox">
<div class="summary">
<p>If an uncaught exception or unhandled rejection was detected in the meantime,
keep the fatal exit code 2 that is already assigned to <code>process.exitCode</code>.
...
in case of an uncaught exception or unhandled rejection.</p>
</div>
<div class="body">
<p>Otherwise, assign the exit code returned from CLI.</p>
</div>
</div>

        </td>
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-keyword">if</span> (!hadFatalError) {
